...
/**
 * Declares an expected {@link System.Logger} event that the class under test should record during a
 * test run.
 * <p>
 * Expectations are evaluated asynchronously via a {@link CountDownLatch} so they work correctly
 * whether the logging call is made on the calling thread or on a background thread (as is common
 * in the async blocks in this module).
 * <p>
...
public final class LogExpectation {
    ...
    /**
     * Returns a new Builder that will construct a new instance of a {@link LogExpectation}.
     *
    ...
    /**
     * A builder for creating an instance of {@link LogExpectation}.  Obtain via
     * {@link LogExpectation#builder()}.
     */
    public static final class Builder {
         ...
         *
         * @param predicate A {@link Predicate} over {@link SystemLogEvent}.
         * @return The current Builder instance.
         */
        ...
        /**
         * Overrides the default failure message shown when the expectation is not satisfied within
         * the timeout period.
         *
         * @param failureMessage A user-friendly message.
         * @return The current Builder instance.
         */
        ...
        /**
         * Returns a new {@link LogExpectation} instance configured by this builder.
         *
         * @return A new {@link LogExpectation} instance.
         */
