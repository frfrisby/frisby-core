...
/**
 * Static utility methods for validating {@link ZonedDateTime} argument values.
 *
 ...
 *       <pre>this.submittedAt = ZonedDateTimes.pastOrPresent("submittedAt", submittedAt);</pre></li>
 ...
 *       {@link ZonedDateTimeOutsideRangeException} (value outside the specified constraint)
 ...
 * two fixed {@link ZonedDateTime} bounds, following the same naming convention as
 ...
 * </ul>
 *
 * <p>Note that {@link ZonedDateTime} comparisons are based on the actual instant in time,
 * adjusting for each value's zone rules. Two {@link ZonedDateTime} values representing
 * the same instant in different time zones are considered equal for comparison purposes.
 *
 ...
 * matches the behavior of {@link ZonedDateTime#now()}.
 *
...
public final class ZonedDateTimes {
     ...
     */
    public static ZonedDateTime notNull(String name, ZonedDateTime value) {
     ...
     * @throws NullValueException                 if {@code value} is null.
     * @throws ZonedDateTimeOutsideRangeException if {@code value} is before {@code min}.
     */
    public static ZonedDateTime min(String name, ZonedDateTime value, ZonedDateTime min) {
        Throws.ifInvalidName(name);
     ...
     * @throws NullValueException                 if {@code value} is null.
     * @throws ZonedDateTimeOutsideRangeException if {@code value} is after {@code max}.
     */
    public static ZonedDateTime max(String name, ZonedDateTime value, ZonedDateTime max) {
        Throws.ifInvalidName(name);
     ...
     * @throws NullPointerException               if {@code name} is null or blank, or if {@code min} is null.
     * @throws NullValueException                 if {@code value} is null.
     * @throws ZonedDateTimeOutsideRangeException if {@code value} is at or before {@code min}.
     */
    public static ZonedDateTime minExclusive(String name, ZonedDateTime value, ZonedDateTime min) {
        Throws.ifInvalidName(name);
        Throws.ifNull(MIN, min);
     ...
     * @throws NullPointerException               if {@code name} is null or blank, or if {@code max} is null.
     * @throws NullValueException                 if {@code value} is null.
     * @throws ZonedDateTimeOutsideRangeException if {@code value} is at or after {@code max}.
     */
    public static ZonedDateTime maxExclusive(String name, ZonedDateTime value, ZonedDateTime max) {
        Throws.ifInvalidName(name);
        Throws.ifNull(MAX, max);
     ...
     * @throws NullValueException                 if {@code value} is null.
     * @throws ZonedDateTimeOutsideRangeException if {@code value} is outside [{@code min}, {@code max}].
     */
    public static ZonedDateTime range(String name, ZonedDateTime value, ZonedDateTime min, ZonedDateTime max) {
        Throws.ifInvalidName(name);
        Throws.ifNull(MIN, min);
        Throws.ifNull(MAX, max);
     ...
     * @throws ZonedDateTimeOutsideRangeException if {@code value} is outside ({@code min}, {@code max}).
     */
    public static ZonedDateTime exclusiveRange(String name, ZonedDateTime value, ZonedDateTime min, ZonedDateTime max) {
        Throws.ifInvalidName(name);
     ...
     * @throws ZonedDateTimeOutsideRangeException if {@code value} is outside [{@code min}, {@code max}).
     */
    public static ZonedDateTime rangeExclusiveMax(String name, ZonedDateTime value, ZonedDateTime min, ZonedDateTime max) {
        Throws.ifInvalidName(name);
     ...
     * @throws ZonedDateTimeOutsideRangeException if {@code value} is outside ({@code min}, {@code max}].
     */
    public static ZonedDateTime rangeExclusiveMin(String name, ZonedDateTime value, ZonedDateTime min, ZonedDateTime max) {
        Throws.ifInvalidName(name);
     ...
     * @throws NullPointerException               if {@code name} is null or blank.
     * @throws NullValueException                 if {@code value} is null.
     * @throws ZonedDateTimeOutsideRangeException if {@code value} is at or after now.
     */
    public static ZonedDateTime past(String name, ZonedDateTime value) {
     ...
     * @throws ZonedDateTimeOutsideRangeException if {@code value} is at or after now.
     */
    public static ZonedDateTime past(String name, ZonedDateTime value, Clock clock) {
        Throws.ifInvalidName(name);
        Throws.ifNull(CLOCK, clock);

        if (null == value) throw nullValue(name);
        if (!value.isBefore(ZonedDateTime.now(clock))) throw notInPast(name);
     ...
     * @throws NullPointerException               if {@code name} is null or blank.
     * @throws NullValueException                 if {@code value} is null.
     * @throws ZonedDateTimeOutsideRangeException if {@code value} is after now.
     */
    public static ZonedDateTime pastOrPresent(String name, ZonedDateTime value) {
     ...
     * @throws ZonedDateTimeOutsideRangeException if {@code value} is after now.
     */
    public static ZonedDateTime pastOrPresent(String name, ZonedDateTime value, Clock clock) {
     ...
     * @throws NullValueException                 if {@code value} is null.
     * @throws ZonedDateTimeOutsideRangeException if {@code value} is after {@code now + tolerance}.
     */
    public static ZonedDateTime pastOrPresent(String name, ZonedDateTime value, Duration tolerance) {
     ...
     * @throws ZonedDateTimeOutsideRangeException if {@code value} is after {@code now + tolerance}.
     */
    public static ZonedDateTime pastOrPresent(String name, ZonedDateTime value, Duration tolerance, Clock clock) {
        Throws.ifInvalidName(name);
        Throws.ifNull(TOLERANCE, tolerance);
        Throws.ifNull(CLOCK, clock);

        if (null == value) throw nullValue(name);
        if (value.isAfter(ZonedDateTime.now(clock).plus(tolerance))) throw notPastOrPresent(name);
     ...
     * @throws NullPointerException               if {@code name} is null or blank.
     * @throws NullValueException                 if {@code value} is null.
     * @throws ZonedDateTimeOutsideRangeException if {@code value} is before now.
     */
    public static ZonedDateTime futureOrPresent(String name, ZonedDateTime value) {
     ...
     * @throws ZonedDateTimeOutsideRangeException if {@code value} is before now.
     */
    public static ZonedDateTime futureOrPresent(String name, ZonedDateTime value, Clock clock) {
     ...
     * @throws NullPointerException               if {@code name} is null or blank, or if {@code tolerance} is null.
     * @throws NullValueException                 if {@code value} is null.
     * @throws ZonedDateTimeOutsideRangeException if {@code value} is before {@code now - tolerance}.
     */
    public static ZonedDateTime futureOrPresent(String name, ZonedDateTime value, Duration tolerance) {
     ...
     * @throws ZonedDateTimeOutsideRangeException if {@code value} is before {@code now - tolerance}.
     */
    public static ZonedDateTime futureOrPresent(String name, ZonedDateTime value, Duration tolerance, Clock clock) {
        Throws.ifInvalidName(name);
        Throws.ifNull(TOLERANCE, tolerance);
        Throws.ifNull(CLOCK, clock);

        if (null == value) throw nullValue(name);
        if (value.isBefore(ZonedDateTime.now(clock).minus(tolerance))) throw notFutureOrPresent(name);
     ...
     * @throws NullPointerException               if {@code name} is null or blank.
     * @throws NullValueException                 if {@code value} is null.
     * @throws ZonedDateTimeOutsideRangeException if {@code value} is at or before now.
     */
    public static ZonedDateTime future(String name, ZonedDateTime value) {
     ...
     * @throws ZonedDateTimeOutsideRangeException if {@code value} is at or before now.
     */
    public static ZonedDateTime future(String name, ZonedDateTime value, Clock clock) {
        Throws.ifInvalidName(name);
        Throws.ifNull(CLOCK, clock);

        if (null == value) throw nullValue(name);
        if (!value.isAfter(ZonedDateTime.now(clock))) throw notInFuture(name);
     ...
     * @throws ZonedDateTimeOutsideRangeException if {@code value} is before {@code min}.
     */
    public static ZonedDateTime optionalMin(String name, ZonedDateTime value, ZonedDateTime min) {
        Throws.ifInvalidName(name);
        Throws.ifNull(MIN, min);
     ...
     * @throws ZonedDateTimeOutsideRangeException if {@code value} is after {@code max}.
     */
    public static ZonedDateTime optionalMax(String name, ZonedDateTime value, ZonedDateTime max) {
        Throws.ifInvalidName(name);
        Throws.ifNull(MAX, max);
     ...
     * @throws ZonedDateTimeOutsideRangeException if {@code value} is at or before {@code min}.
     */
    public static ZonedDateTime optionalMinExclusive(String name, ZonedDateTime value, ZonedDateTime min) {
        Throws.ifInvalidName(name);
        Throws.ifNull(MIN, min);
     ...
     * @throws ZonedDateTimeOutsideRangeException if {@code value} is at or after {@code max}.
     */
    public static ZonedDateTime optionalMaxExclusive(String name, ZonedDateTime value, ZonedDateTime max) {
        Throws.ifInvalidName(name);
        Throws.ifNull(MAX, max);
     ...
     * @throws ZonedDateTimeOutsideRangeException if {@code value} is outside [{@code min}, {@code max}].
     */
    public static ZonedDateTime optionalRange(String name, ZonedDateTime value, ZonedDateTime min, ZonedDateTime max) {
        Throws.ifInvalidName(name);
        Throws.ifNull(MIN, min);
        Throws.ifNull(MAX, max);
        if (max.isBefore(min)) throw maxLtMin(max, min);
     ...
     * @throws ZonedDateTimeOutsideRangeException if {@code value} is outside ({@code min}, {@code max}).
     */
    public static ZonedDateTime optionalExclusiveRange(String name, ZonedDateTime value, ZonedDateTime min, ZonedDateTime max) {
        Throws.ifInvalidName(name);
     ...
     * @throws ZonedDateTimeOutsideRangeException if {@code value} is outside [{@code min}, {@code max}).
     */
    public static ZonedDateTime optionalRangeExclusiveMax(String name, ZonedDateTime value, ZonedDateTime min, ZonedDateTime max) {
        Throws.ifInvalidName(name);
     ...
     * @throws ZonedDateTimeOutsideRangeException if {@code value} is outside ({@code min}, {@code max}].
     */
    public static ZonedDateTime optionalRangeExclusiveMin(String name, ZonedDateTime value, ZonedDateTime min, ZonedDateTime max) {
        Throws.ifInvalidName(name);
     ...
     * @throws ZonedDateTimeOutsideRangeException if {@code value} is at or after now.
     */
    public static ZonedDateTime optionalPast(String name, ZonedDateTime value) {
     ...
     * @throws ZonedDateTimeOutsideRangeException if {@code value} is at or after now.
     */
    public static ZonedDateTime optionalPast(String name, ZonedDateTime value, Clock clock) {
        Throws.ifInvalidName(name);
        Throws.ifNull(CLOCK, clock);
     ...
     * @throws ZonedDateTimeOutsideRangeException if {@code value} is after now.
     */
    public static ZonedDateTime optionalPastOrPresent(String name, ZonedDateTime value) {
     ...
     * @throws ZonedDateTimeOutsideRangeException if {@code value} is after now.
     */
    public static ZonedDateTime optionalPastOrPresent(String name, ZonedDateTime value, Clock clock) {
     ...
     * @throws ZonedDateTimeOutsideRangeException if {@code value} is after {@code now + tolerance}.
     */
    public static ZonedDateTime optionalPastOrPresent(String name, ZonedDateTime value, Duration tolerance) {
     ...
     * @throws ZonedDateTimeOutsideRangeException if {@code value} is after {@code now + tolerance}.
     */
    public static ZonedDateTime optionalPastOrPresent(String name, ZonedDateTime value, Duration tolerance, Clock clock) {
        Throws.ifInvalidName(name);
        Throws.ifNull(TOLERANCE, tolerance);
        Throws.ifNull(CLOCK, clock);
     ...
     * @throws ZonedDateTimeOutsideRangeException if {@code value} is before now.
     */
    public static ZonedDateTime optionalFutureOrPresent(String name, ZonedDateTime value) {
     ...
     * @throws ZonedDateTimeOutsideRangeException if {@code value} is before now.
     */
    public static ZonedDateTime optionalFutureOrPresent(String name, ZonedDateTime value, Clock clock) {
     ...
     * @throws ZonedDateTimeOutsideRangeException if {@code value} is before {@code now - tolerance}.
     */
    public static ZonedDateTime optionalFutureOrPresent(String name, ZonedDateTime value, Duration tolerance) {
     ...
     * @throws ZonedDateTimeOutsideRangeException if {@code value} is before {@code now - tolerance}.
     */
    public static ZonedDateTime optionalFutureOrPresent(String name, ZonedDateTime value, Duration tolerance, Clock clock) {
        Throws.ifInvalidName(name);
        Throws.ifNull(TOLERANCE, tolerance);
        Throws.ifNull(CLOCK, clock);
     ...
     * @throws ZonedDateTimeOutsideRangeException if {@code value} is at or before now.
     */
    public static ZonedDateTime optionalFuture(String name, ZonedDateTime value) {
     ...
     * @throws ZonedDateTimeOutsideRangeException if {@code value} is at or before now.
     */
    public static ZonedDateTime optionalFuture(String name, ZonedDateTime value, Clock clock) {
        Throws.ifInvalidName(name);
        Throws.ifNull(CLOCK, clock);
    ...
    private static void throwIfExclusiveBoundsInvalid(ZonedDateTime min, ZonedDateTime max) {
        Throws.ifNull(MIN, min);
        Throws.ifNull(MAX, max);
    ...
    private static ZonedDateTimeOutsideRangeException tooSmall(String name, ZonedDateTime min) {
        return new ZonedDateTimeOutsideRangeException(
                String.format(
    ...
    private static ZonedDateTimeOutsideRangeException tooSmallExclusive(String name, ZonedDateTime bound) {
        return new ZonedDateTimeOutsideRangeException(
                String.format(
    ...
    private static ZonedDateTimeOutsideRangeException tooLarge(String name, ZonedDateTime max) {
        return new ZonedDateTimeOutsideRangeException(
                String.format(
    ...
    private static ZonedDateTimeOutsideRangeException tooLargeExclusive(String name, ZonedDateTime bound) {
        return new ZonedDateTimeOutsideRangeException(
                String.format(
    ...
    private static ZonedDateTimeOutsideRangeException notInPast(String name) {
        return new ZonedDateTimeOutsideRangeException(
                String.format(
    ...
    private static ZonedDateTimeOutsideRangeException notPastOrPresent(String name) {
        return new ZonedDateTimeOutsideRangeException(
                String.format(
    ...
    private static ZonedDateTimeOutsideRangeException notFutureOrPresent(String name) {
        return new ZonedDateTimeOutsideRangeException(
                String.format(
    ...
    private static ZonedDateTimeOutsideRangeException notInFuture(String name) {
        return new ZonedDateTimeOutsideRangeException(
                String.format(
    ...
    private static IllegalConfigurationException maxLtMin(ZonedDateTime max, ZonedDateTime min) {
    ...
    private static IllegalConfigurationException maxLeMin(ZonedDateTime max, ZonedDateTime min) {
        return new IllegalConfigurationException(
                String.format(
