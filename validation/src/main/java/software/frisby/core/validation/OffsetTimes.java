...
/**
 * Static utility methods for validating {@link OffsetTime} argument values.
 *
 ...
 *       <pre>this.openTime = OffsetTimes.min("openTime", openTime, EARLIEST_OPEN);</pre></li>
 ...
 *       {@link OffsetTimeOutsideRangeException} (value outside the specified constraint)
 ...
 * ({@code past}, {@code future}, etc.) are not offered because an {@link OffsetTime} value
 * represents a time-of-day with a UTC offset but no date; "past" and "future" have no
 * well-defined meaning for such a value.
 *
 * <p>Note that {@link OffsetTime} comparisons are based on the actual instant in time,
 * adjusting for the UTC offset. Two {@link OffsetTime} values representing the same
 * wall-clock time in different offsets are therefore not equal; the one with the larger
 * positive offset represents an earlier instant and is considered smaller.
 *
...
public final class OffsetTimes {
     ...
     */
    public static OffsetTime notNull(String name, OffsetTime value) {
     ...
     * @throws NullValueException              if {@code value} is null.
     * @throws OffsetTimeOutsideRangeException if {@code value} is before {@code min}.
     */
    public static OffsetTime min(String name, OffsetTime value, OffsetTime min) {
        Throws.ifInvalidName(name);
     ...
     * @throws NullValueException              if {@code value} is null.
     * @throws OffsetTimeOutsideRangeException if {@code value} is after {@code max}.
     */
    public static OffsetTime max(String name, OffsetTime value, OffsetTime max) {
        Throws.ifInvalidName(name);
     ...
     * @throws NullPointerException            if {@code name} is null or blank, or if {@code min} is null.
     * @throws NullValueException              if {@code value} is null.
     * @throws OffsetTimeOutsideRangeException if {@code value} is at or before {@code min}.
     */
    public static OffsetTime minExclusive(String name, OffsetTime value, OffsetTime min) {
        Throws.ifInvalidName(name);
        Throws.ifNull(MIN, min);
     ...
     * @throws NullPointerException            if {@code name} is null or blank, or if {@code max} is null.
     * @throws NullValueException              if {@code value} is null.
     * @throws OffsetTimeOutsideRangeException if {@code value} is at or after {@code max}.
     */
    public static OffsetTime maxExclusive(String name, OffsetTime value, OffsetTime max) {
        Throws.ifInvalidName(name);
        Throws.ifNull(MAX, max);
     ...
     * @throws NullValueException              if {@code value} is null.
     * @throws OffsetTimeOutsideRangeException if {@code value} is outside [{@code min}, {@code max}].
     */
    public static OffsetTime range(String name, OffsetTime value, OffsetTime min, OffsetTime max) {
        Throws.ifInvalidName(name);
        Throws.ifNull(MIN, min);
        Throws.ifNull(MAX, max);
     ...
     * @throws OffsetTimeOutsideRangeException if {@code value} is outside ({@code min}, {@code max}).
     */
    public static OffsetTime exclusiveRange(String name, OffsetTime value, OffsetTime min, OffsetTime max) {
        Throws.ifInvalidName(name);
     ...
     * @throws OffsetTimeOutsideRangeException if {@code value} is outside [{@code min}, {@code max}).
     */
    public static OffsetTime rangeExclusiveMax(String name, OffsetTime value, OffsetTime min, OffsetTime max) {
        Throws.ifInvalidName(name);
        throwIfExclusiveBoundsInvalid(min, max);
     ...
     * @throws OffsetTimeOutsideRangeException if {@code value} is outside ({@code min}, {@code max}].
     */
    public static OffsetTime rangeExclusiveMin(String name, OffsetTime value, OffsetTime min, OffsetTime max) {
        Throws.ifInvalidName(name);
        throwIfExclusiveBoundsInvalid(min, max);
     ...
     * @throws OffsetTimeOutsideRangeException if {@code value} is before {@code min}.
     */
    public static OffsetTime optionalMin(String name, OffsetTime value, OffsetTime min) {
        Throws.ifInvalidName(name);
        Throws.ifNull(MIN, min);
     ...
     * @throws OffsetTimeOutsideRangeException if {@code value} is after {@code max}.
     */
    public static OffsetTime optionalMax(String name, OffsetTime value, OffsetTime max) {
        Throws.ifInvalidName(name);
        Throws.ifNull(MAX, max);
     ...
     * @throws OffsetTimeOutsideRangeException if {@code value} is at or before {@code min}.
     */
    public static OffsetTime optionalMinExclusive(String name, OffsetTime value, OffsetTime min) {
        Throws.ifInvalidName(name);
        Throws.ifNull(MIN, min);
     ...
     * @throws OffsetTimeOutsideRangeException if {@code value} is at or after {@code max}.
     */
    public static OffsetTime optionalMaxExclusive(String name, OffsetTime value, OffsetTime max) {
        Throws.ifInvalidName(name);
        Throws.ifNull(MAX, max);
     ...
     * @throws OffsetTimeOutsideRangeException if {@code value} is outside [{@code min}, {@code max}].
     */
    public static OffsetTime optionalRange(String name, OffsetTime value, OffsetTime min, OffsetTime max) {
        Throws.ifInvalidName(name);
        Throws.ifNull(MIN, min);
        Throws.ifNull(MAX, max);
        if (max.isBefore(min)) throw maxLtMin(max, min);
     ...
     * @throws OffsetTimeOutsideRangeException if {@code value} is outside ({@code min}, {@code max}).
     */
    public static OffsetTime optionalExclusiveRange(String name, OffsetTime value, OffsetTime min, OffsetTime max) {
        Throws.ifInvalidName(name);
        throwIfExclusiveBoundsInvalid(min, max);
     ...
     * @throws OffsetTimeOutsideRangeException if {@code value} is outside [{@code min}, {@code max}).
     */
    public static OffsetTime optionalRangeExclusiveMax(String name, OffsetTime value, OffsetTime min, OffsetTime max) {
        Throws.ifInvalidName(name);
        throwIfExclusiveBoundsInvalid(min, max);
     ...
     * @throws OffsetTimeOutsideRangeException if {@code value} is outside ({@code min}, {@code max}].
     */
    public static OffsetTime optionalRangeExclusiveMin(String name, OffsetTime value, OffsetTime min, OffsetTime max) {
        Throws.ifInvalidName(name);
        throwIfExclusiveBoundsInvalid(min, max);
    ...
    private static void throwIfExclusiveBoundsInvalid(OffsetTime min, OffsetTime max) {
        Throws.ifNull(MIN, min);
        Throws.ifNull(MAX, max);
    ...
    private static OffsetTimeOutsideRangeException tooSmall(String name, OffsetTime min) {
        return new OffsetTimeOutsideRangeException(
                String.format(
    ...
    private static OffsetTimeOutsideRangeException tooSmallExclusive(String name, OffsetTime bound) {
        return new OffsetTimeOutsideRangeException(
                String.format(
    ...
    private static OffsetTimeOutsideRangeException tooLarge(String name, OffsetTime max) {
        return new OffsetTimeOutsideRangeException(
                String.format(
    ...
    private static OffsetTimeOutsideRangeException tooLargeExclusive(String name, OffsetTime bound) {
        return new OffsetTimeOutsideRangeException(
                String.format(
    ...
    private static IllegalConfigurationException maxLtMin(OffsetTime max, OffsetTime min) {
    ...
    private static IllegalConfigurationException maxLeMin(OffsetTime max, OffsetTime min) {
        return new IllegalConfigurationException(
                String.format(
