...
/**
 * Thrown when a {@link FieldGroups} cardinality constraint finds that more
 * fields in a {@link FieldGroup} have been provided than the constraint permits.
 *
 * @see FieldGroups
 */
public class TooManyFieldsException extends IllegalArgumentException {
    @Serial
